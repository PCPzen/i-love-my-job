                        ...
                        <table className="table-auto border-collapse border border-gray-800 text-sm max-w-4xl mx-auto">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="border border-gray-800 px-4 py-2 text-center text-black">15</td>
                                    <td className="border border-gray-800 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-800 px-4 py-2 text-center ${totalRemedial !== 15 ? 'text-red-500' : 'text-green-500'
                                        }`}>
                                        {totalRemedial}
                                    </th>
                                    <td className="border border-gray-800 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                ...
                                <tr>
                                    ...
                                    <td className="border border-gray-800 px-4 py-2 text-center text-black">หน่วยกิต</td>
                                    <th className={`border border-gray-800 px-4 py-2 text-center ${(creditA + creditB + creditC + creditD + creditE + creditF + totalRemedial) !== 95 ? 'text-red-500' : 'text-green-500'
                                        }`}>
