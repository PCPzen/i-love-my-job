...
const StudyPlan = () => {
    ...
    if (!planDetails) {
        axios.get(`${API_BASE_URL}/api/GET/Getstudyplan.php?planid=${planid}`)
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(
                `${API_BASE_URL}/api/GET/Getgroupforgroup.php?planid=${planid}`
            );
    ...
    const handleSaveSummer = (planid, summer) => {
        ...
        axios.post(`${API_BASE_URL}/api/UPDATE/updateSummer.php`, { planid, summer })
            .then(response => {
    ...
    const handleDelete = async (planid, groupName) => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await axios.get(`${API_BASE_URL}/api/DELETE/Delete_group_information.php`, {
                    params: {
                        planid: planid,
    ...
    const fetchSummerData = async (planid) => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/GET/Get_group_information.php?planid=${planid}`);
    ...
    const handleEditSummer = (filteredData) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                try {
                    const response = await axios.post(`${API_BASE_URL}/api/UPDATE/updateSummer.php`, {
