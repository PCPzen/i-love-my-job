...
const Printplan = () => {
    ...
    useEffect(() => {
        if (planid) {
            axios.get(`${API_BASE_URL}/api/GET/Get_plan_detail.php`, {
                params: { planid },
            }).then((response) => {
    ...
    useEffect(() => {
        if (planid) {
            axios.get(`${API_BASE_URL}/api/GET/Getgroupforgroup.php`, {
                params: { planid },
            }).then((response) => {
    ...
    useEffect(() => {
        if (selectedGroup) {
            axios.get(`${API_BASE_URL}/api/GET/Get_printcourse_information.php`, {
    ...
    const handleSave = () => {
        axios.post(`${API_BASE_URL}/api/POST/save_more_plan.php`, {
            planid,
    ...
    useEffect(() => {
        if (selectedGroup && planid) {
            axios.get(`${API_BASE_URL}/api/GET/get_more_plan.php`, {
                params: {
                    planid,
                    infoid: selectedGroup
                }
